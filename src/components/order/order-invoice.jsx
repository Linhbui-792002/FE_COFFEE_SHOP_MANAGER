...
const OrderInvoice = React.forwardRef(
  ({ orderDetails, totalQuantityOrder, totalMoney, receivedMoney, discountMoney }, ref) => {
    return (
          ...
          <div className="flex flex-col gap-2 flex-grow">
            ...
            <div className="grid grid-cols-12 gap-2 mt-8">
              ...
              <div className="col-span-3 font-bold text-right">
                <span className="line-through text-gray-400 font-semibold">{totalMoney}</span>{' '}
                <span>{currencyFormatter(totalMoney - discountMoney)}</span>
              </div>
            </div>
            <div className="grid grid-cols-12 gap-2">
              <div className="col-span-9 text-end font-bold">Discount:</div>
              <div className="col-span-3 font-bold text-end">{currencyFormatter(discountMoney)}</div>
            </div>
            <div className="grid grid-cols-12 gap-2">
            ...
            <div className="grid grid-cols-12 gap-2">
              ...
              <div className="col-span-3 font-bold text-end">
                {currencyFormatter(receivedMoney - (totalMoney - discountMoney))}
              </div>
            </div>
          </div>
        </div>
